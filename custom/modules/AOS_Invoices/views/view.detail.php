...
/**
 * Class AOS_InvoicesViewDetail
 */
class CustomAOS_InvoicesViewDetail extends AOS_InvoicesViewDetail
{
    /**
     * @var AOS_Invoices $bean;
     */
    public $bean;

    /**
     * AOS_InvoicesViewDetail constructor.
     */
    ...
    protected function displayPopupHtmlCustom()
    {
        ...
        if ($templatesList) {
            ...
            echo $template->fetch('custom/modules/AOS_Invoices/templates/showPopupWithTemplates.tpl');
        } else {
            echo $template->fetch('modules/AOS_Invoices/templates/showPopupWithOutTemplates.tpl');
        }
    }
}